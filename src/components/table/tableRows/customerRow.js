...
export default function CustomerRow({ isLoading, row }) {
                    ...
                    {isLoading ? (
                        ...
                        <>
                            <Tooltip title="Preview">
                                <IconButton onClick={() => navigate(`/customers/${row?._id}`)}>
                                    <RemoveRedEyeIcon />
                                </IconButton>
                            </Tooltip>
                            <Tooltip title="Add Product">
                                <IconButton onClick={() => navigate(`/customers/${row?._id}/addproduct`)}>
                                    <AddShoppingCartIcon />
                                </IconButton>
                            </Tooltip>
