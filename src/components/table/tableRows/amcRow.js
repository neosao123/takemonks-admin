    ...
    return (
        <TableRow hover key={Math.random()}>
            ...
            <TableCell component="th" scope="row" padding="10px" >
                {" "}
                {isLoading ? <Skeleton variant="text" /> : row?.productId?.name?.length > 15 ? `${row?.productId?.name?.slice(0, 15)}...` : row?.productId?.name}
                {" "}
            </TableCell>
            ...
            <TableCell component="th" scope="row" padding="10px">
                {" "}
                {isLoading ? <Skeleton variant="text" /> : row?.durationType.toUpperCase()}
                {" "}
            </TableCell>
            <TableCell component="th" scope="row" padding="10px">
                {" "}
